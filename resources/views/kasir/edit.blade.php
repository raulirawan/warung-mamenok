            ...
            <div class="col-md-6 offset-3">
                ...
                <form action="/kasir/{{ $kasir->id }}/update" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <div class="gambar">
                            <img src="{{ asset($kasir->gambar) }}" id="preview_gambar" class="img-thumbnail" width="300"
                                alt="No Image"><br><br>
                            <input onchange="readURL(this);" value="{{ $kasir->gambar }}" required type="file"
                                name="gambar" class="" id="exampleInputEmail1" aria-describedby="emailHelp"><br><br>
                        </div>
                        <label for="exampleInputEmail1">Nama Menu</label>
                        <input type="text" value="{{ $kasir->nama_menu }}" name="nama_menu" class="form-control"
