        ...
        <div class="col-md-6">
            ...
            <div class="row">
                <div class="col-md-6 offset-2">
                    <span><button type="button" style="margin-top:-40px;margin-right:-10px" class="btn btn-primary btn-sm float-right" data-toggle="modal" data-target="#exampleModal">
                        Tambah Menu
                    </button></span>
                </div>
            </div>
        ...
        <tbody id="myTable">
                <tr>
                        ...
                        <td class="text-center">
                            ...
                            <a href="/kasir/{{$row->id}}/delete" style="color:red" onclick="return confirm('Yakin ?')">Delete</a>
                        </td>
                    </tr>
        </tbody>
        @endforeach
