                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    @auth
                        @if (Auth::user()->roles == 'ADMIN')
                            <ul class="navbar-nav mr-auto">
                                <div class="navbar-nav">
                                    ...
                                    <a class="nav-item nav-link" href="{{ url('/kasir') }}">Menu</a>
                                    <a class="nav-item nav-link" href="{{ url('/slider') }}">Slider</a>
                        ...
                        @else
                            <ul class="navbar-nav mr-auto">
                                <div class="navbar-nav">
                                    <a class="nav-item nav-link active" href="{{ url('/customer/home') }}">Home </a>
                                </div>
                            </ul>
                        @endif
                    @endauth
